...
controller.hears('update_file:(.*)',["direct_message","direct_mention","mention","ambient"],function(bot,message) {
    var msg = 'bbbbbbbbbbbbbb...';
    msg = 'clear file Under processing...';
    var url = '';
    if (message.match[1] === '') {
...
controller.hears('whoami',["direct_message","direct_mention","mention","ambient"],function(bot,message) {
    exec_cmd('whoami', function (output) {
